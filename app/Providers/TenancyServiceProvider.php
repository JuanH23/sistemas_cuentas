...
protected function addTenancyLogs()
{
    Event::listen(Events\TenancyInitialized::class, function (Events\TenancyInitialized $event) {
        \Log::info('🟢 Tenancy INITIALIZED', [
            ...
            'tenant_name' => $event->tenancy->tenant->name,
    ...
    Event::listen(Events\InitializingTenancy::class, function () {
        \Log::info('🟡 Tenancy INITIALIZING...');
    });
}
}
