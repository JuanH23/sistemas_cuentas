...
use App\Filament\App\Resources\AccountPayableResource\Pages;
...
class AccountPayableResource extends Resource
{
    ...
    {
        return $form->schema([
            // Aquí se captura el nombre del proveedor, la factura, el total y la fecha de vencimiento.
            Forms\Components\TextInput::make('provider_name')->label('Proveedor')->required(),
            ...
            // El paid_amount se inicializa en 0 y normalmente no se edita manualmente.
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            ...
            Tables\Columns\TextColumn::make('provider_name')->label('Proveedor'),
            Tables\Columns\TextColumn::make('total_amount')->label('Total'),
            Tables\Columns\TextColumn::make('paid_amount')->label('Abonado'),
